# import xmlVocReadAnnotationsFile
...
#     list_of_images = list()
#     list_of_annotated_images = list()
#     list_of_not_annotated_images = list()
#
#     # Index of images
#     image_index = 0
...
# msn = item[nbItems - 2]
# type = item[nbItems - 3]
# image_info = list("type" = > type, "msn" = > msn,
#                                              "name" = > image_name)
#
...
# id = str_replace(list(".jpg", ".JPG"), ".jpg", image_name)
# xml_filename = str_replace(list(".jpg", ".JPG"), ".xml", id)
...
#
# echo
# "Number of images :".count(list_of_images).
# "<br>" * /
#
# # New image 80%
...
#
# # Remove extension
# id = str_replace(list(".jpg", ".JPG"), ".jpg", image_info["name"])
#
...
# annotations = []
# xml = new
# xmlVocReadAnnotationsFile(xml_filepath)
#
...
# data = list("url" = > url, "id" = > id, "folder" = > image_info["type"].
# "/".image_info["msn"],
