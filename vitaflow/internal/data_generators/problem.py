...
def preprocess_example_common(example: dict, mode: str, hparams: HParams):
    """
    Preprocessing steps common to all models.
    Args:
        example (dict) :  Dictionary of features and targets
...
class Problem(object):
    """Problem base class. Specifies a vitaFlow problem/dataset.
