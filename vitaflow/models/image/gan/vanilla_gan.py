...
class UserLogHook(session_run_hook.SessionRunHook):
    ...
    def before_run(self, run_context):
        ...
        if global_step % 2 == 0 or global_step % 3 == 0 :
            ...
            if not os.path.exists(os.path.join(os.path.expanduser("~"), "vitaFlow/runtime/VanillaGAN")): os.makedirs(EXPERIMENT_DATA_ROOT_DIR+'/vanilla_gan/' )

            images_grid.save(os.path.join(os.path.expanduser("~"), "vitaFlow/runtime/VanillaGAN", '/step_{}.png'.format(global_step)))
...
class VanillaGAN(ModelBase, ImageFeature):
    ...
    def discriminator(self, images, reuse=False):
        ...
        with tf.variable_scope('discriminator', reuse=reuse):
            ...
            print_info("======>discriminator out: {}".format(out))
