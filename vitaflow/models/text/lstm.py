...
class LSTMEncoder(vf_model.VfModel):
  """LSTM encoder only."""
...
@registry.register_model
class LSTMSeq2seq(vf_model.VfModel):
...
@registry.register_model
class LSTMSeq2seqAttention(vf_model.VfModel):
...
@registry.register_model
class LSTMSeq2seqBidirectionalEncoder(vf_model.VfModel):
...
@registry.register_model
class LSTMSeq2seqAttentionBidirectionalEncoder(vf_model.VfModel):
