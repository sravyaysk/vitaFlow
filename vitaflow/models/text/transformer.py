...
from vitaflow.internal.data_generators import librispeech
...
from vitaflow.internal.layers import transformer_layers
from vitaflow.utils import beam_search
from vitaflow.utils import expert_utils
...
class Transformer(vf_model.VfModel):
...
@registry.register_model
class TransformerEncoder(vf_model.VfModel):
